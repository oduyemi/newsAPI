...
const createNews = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { title, text, image, tags, tagId, authorId, status, content, summary, source, url, socialMedia, relatedNews } = req.body;
...
const updateNews = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedNews = yield news_model_1.default.findByIdAndUpdate(id, { title, text, image, tags, tagId, authorId, status, content, summary, source, url, socialMedia, relatedNews }, { new: true }).populate("tagId", "name description")
            .populate("authorId", "name email");
        if (!updatedNews) {
            res.status(404).json({ success: false, message: "News not found" });
            return;
